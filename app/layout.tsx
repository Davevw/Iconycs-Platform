...
export const metadata: Metadata = {
  ...
  description: 'AI-powered housing analytics platform. 109M+ property records, 258M+ homeowner profiles, and census-tract demographics across all 50 states -- built for capital markets.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'ICONYCS | 109M Properties. Every U.S. Neighborhood. Real Data.',
    description: 'AI-powered housing analytics. 109M+ property records, 258M+ homeowner profiles, census-tract demographics -- built for capital markets.',
  },
