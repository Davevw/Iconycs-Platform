...
const TIERS = [
  {
    ...
    features: [
      ...
      'Basic charts & breakdown views',
      '3 report views per day',
      'Ethnicity + loan type breakdown',
      'Basic map navigation',
    ],
    locked: [
      'County / City / ZIP drill-down',
      'Full demographics deep dive',
      'PDF export',
  ...
  },
  {
    ...
    ctaStyle: 'primary',
    popular: false,
    priceId: 'price_1TIbbH9CvaSs0o4ACH7uaAGG',
    features: [
      'Full geography drill-down',
      'County, city & ZIP-level data',
      'All demographic dimensions',
      'PDF & print export',
      'Cascade Report Builder',
      'Unlimited report views',
      'Ethnicity, income, education, wealth',
    ],
    locked: [
      'Social Housing Score',
      'Matrix Builder',
  ...
  },
  {
    ...
    ctaStyle: 'inverse',
    popular: true,
    priceId: 'price_1TIbbI9CvaSs0o4An8tfp1fS',
    features: [
  ...
  },
  {
    ...
    ctaStyle: 'gold',
    popular: false,
    priceId: 'price_1TIbbJ9CvaSs0o4A4wpO81yP',
    features: [
