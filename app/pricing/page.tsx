...
const TIERS = [
  {
    ...
    price: '$0',
    period: '/month',
    description: 'National views only. No download rights. No credit card required.',
    features: [
      'National-level data only',
      'Basic ethnicity & loan charts',
      '3 report views per day',
      'No download or export rights',
    ],
    cta: 'Start Free',
    ctaLink: '/reports',
    highlighted: false,
