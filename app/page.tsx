...
export const metadata: Metadata = {
  ...
  description:
    'ICONYCS Housing Intelligence combines 109M+ residential properties with 73.6M+ owner demographic profiles. AI-powered analytics by ethnicity, income, education, and more. When Housing Markets Shift, Iconycs Knows.',
  keywords: [
